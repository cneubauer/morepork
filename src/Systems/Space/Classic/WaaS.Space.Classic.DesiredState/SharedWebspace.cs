...
public class SharedWebspace : Space.DesiredState.Space, IWebspace, ICredentialContainer
{
    /// <summary>
    ...
    public IEnumerable<ICredential> GetCredentials()
    {
        var credentials = Accounts.Cast<ICredential>().Concat(AdminAccounts);
